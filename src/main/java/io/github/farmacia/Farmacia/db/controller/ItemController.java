...
public class ItemController {
    ...
    @PostMapping 
    public ResponseEntity<Object> salvar(@RequestBody ItemDTO itemDTO){
        
        Item mapear = itemDTO.mapear();
        mapear.setFornecedor(repository.findById(itemDTO.idFornecedor()).orElseThrow(() -> new RuntimeException("Fornecedor não encontrado")));
    ...
    @PutMapping("{id}")
    public ResponseEntity<ItemDTO> atualizar(@PathVariable("id") String id, @RequestBody ItemDTO itemDTO){
        ...
        item.setFornecedor(repository.findById(itemDTO.idFornecedor()).orElseThrow(() -> new RuntimeException("Item não encontrado")));
